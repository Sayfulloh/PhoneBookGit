package com.example.sayfulloh.phonebook.Employees.kotibot.RayKabuliKorho;
...
public class ShubaiKorZerizamini extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shubai_kor_zerizamini);
        ListView listView = (ListView)findViewById(R.id.listViewBox);
        String [] items={"Раҷабов Абдуҷабор\tМутахассиси  пешбар\t98-999-00-68\n", "Сониев Тағай\tМутахассис пешбар\t98-999-00-65\n"};
    ...
    public void showInputBox (String oldItem, final int index){
        final Dialog dialog = new Dialog(ShubaiKorZerizamini.this);
