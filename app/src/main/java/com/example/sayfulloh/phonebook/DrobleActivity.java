...
import com.example.sayfulloh.phonebook.Abount.SayfullohActivity;
...
public class DrobleActivity extends AppCompatActivity
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.droble, menu);
        return true;
    }
    ...
    public void btnAbount(View view) {
        Intent intent = new Intent(this, SayfullohActivity.class);
        startActivity(intent);
    }
}
