...
public class Nur81 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.company_nur81);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        ListView listView = (ListView)findViewById(R.id.listViewBox);
        String [] items={"Сафаралиев  Маҳмадраҳим  Абусаторович\tСармуҳандис\t989991650\n" ,
                "Файзов Умедчон  Мизробоевич\tСармуҳосиб\t989991651\n" ,
                "Асоев Бахтибек\tДиректори генерали\t989-99-2999\n" ,
                "Хушвақтова Саидамоҳ Шомаҳмадовна\tСардори ШК\t989991681\n"};
    ...
    public void showInputBox (String oldItem, final int index){
        final Dialog dialog = new Dialog(Nur81.this);
